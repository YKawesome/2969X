...
// drivetrain Drivetrain = drivetrain(LeftDriveSmart, RightDriveSmart, 299.24, 444.5, 381, mm, 1);
controller Controller1 = controller(primary);
motor Mogo = motor(PORT3, ratio36_1, false);
motor FBar1 = motor(PORT14, ratio18_1, true);

// motor MogoClamp = motor(PORT17, ratio36_1, false);
pneumatics PPmachine = pneumatics(Brain.ThreeWirePort.A);
pneumatics Pclamp = pneumatics(Brain.ThreeWirePort.G);
