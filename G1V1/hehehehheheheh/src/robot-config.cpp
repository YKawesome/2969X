...
motor Launcher = motor(PORT2, ratio18_1, false);
motor Roller = motor(PORT6, ratio18_1, false);
motor LIntake = motor(PORT11, ratio18_1, false);
...
encoder LENC = encoder(Brain.ThreeWirePort.A);
encoder RENC = encoder(Brain.ThreeWirePort.G);
