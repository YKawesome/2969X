...
vex::motor FLWheel(vex::PORT1,vex::gearSetting::ratio18_1,true);
vex::motor FRWheel(vex::PORT2,vex::gearSetting::ratio18_1,false);
vex::motor BLWheel(vex::PORT3,vex::gearSetting::ratio18_1,true);
vex::motor BRWheel(vex::PORT4,vex::gearSetting::ratio18_1,false);
vex::motor Tilter(vex::PORT5,vex::gearSetting::ratio36_1,false);
vex::motor TwoBar(vex::PORT6,vex::gearSetting::ratio36_1,true);
vex::motor LIntake(vex::PORT7,vex::gearSetting::ratio18_1,true);
vex::motor RIntake(vex::PORT8,vex::gearSetting::ratio18_1,false);
/*---------------------------------------------------------------------------*/
...
void fwdIntake (float rotations, float speed) {
    FLWheel.startRotateFor(4,rotationUnits::rev,40,velocityUnits::pct);
    FRWheel.startRotateFor(4,rotationUnits::rev,40,velocityUnits::pct);
    BLWheel.startRotateFor(4,rotationUnits::rev,40,velocityUnits::pct);
    BRWheel.startRotateFor(4,rotationUnits::rev,40,velocityUnits::pct);
    RIntake.startRotateFor(rotations,rotationUnits::rev,speed,velocityUnits::pct);
    LIntake.rotateFor(rotations,rotationUnits::rev,speed,velocityUnits::pct);
}
